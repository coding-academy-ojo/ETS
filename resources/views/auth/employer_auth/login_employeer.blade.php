            ...
            <div class="row ">
                <div class="col-md-12">
                    <div class="login-form">
                        ...
                        <h2 class="mb-4"><img class="ml-1" src="{{ asset('Orange.png') }}" alt="Orange" height="30" class="mr-2">Orange
                            Jordan</h2>
                        <h3 style="margin-">Employer Dashboard</h3>
                        ...
                        @if (session('error'))
    <div class="alert alert-danger color-alert center">
        {{ session('error') }}
    </div>
