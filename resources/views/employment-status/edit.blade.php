        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputFirstName" class="is-required">First Name</label>
                    <input type="text" class="form-control" id="inputFirstName" placeholder="First Name" name="first_name" value="{{ $trainee->first_name }}" required>
                </div>
                <div class="form-group">
                    <label for="inputLastName" class="is-required">Last Name</label>
                    <input type="text" class="form-control" id="inputLastName" placeholder="Last Name" name="last_name" value="{{ $trainee->last_name }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputLinkedIn" class="is-required">LinkedIn</label>
                    <input type="linkedin" class="form-control" id="inputLinkedIn" placeholder="linkedin.com/in/user_name" name="linkedin" value="{{ $trainee->linkedin }}" required>
                </div>
                <div class="form-group">
                    <label for="inputGitHup" class="is-required">GitHub</label>
                    <input type="inputGitHup" class="form-control" id="inputGitHup" placeholder="github.com/user_name" name="git_hub" value="{{ $trainee->git_hub }}" required>
                </div>
                <div class="form-group">
                ...
                <!-- <div class="form-group">
                    <label for="inputemploymentStatus" class="is-required">EmployeeStatus</label>
                    <select class="form-control" id="inputGraduated" name="graduated" required>
                        <option value="Yes" {{ $trainee->employment_status === 'employed' ? 'selected' : '' }}>employed</option>
                        <option value="No" {{ $trainee->graduated === 'unemployed' ? 'selected' : '' }}>unemployed</option>
                    </select>
                </div> -->
                <div class="form-group">
                    <label for="inputCertificatType" class="is-required">Certificate Type</label>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="inputBirthdate" placeholder="Birthdate" name="birthdate" value="{{ $trainee->birthdate }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputPersonalImg" class="is-required">Personal Image</label>
                    <input type="file" class="form-control @error('personal_img') is-invalid @enderror" id="inputPersonalImg" name="personal_img">
                    @error('personal_img')
                ...
                <div class="form-group">
                    <label for="inputPersonalCvs" class="is-required">Personal CVs</label>
                    <input type="file" class="form-control @error('trainee_cv') is-invalid @enderror" id="inputPersonalCvs" name="trainee_cv">
                    @error('trainee_cv')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
